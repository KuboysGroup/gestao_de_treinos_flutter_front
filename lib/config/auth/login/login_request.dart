...
import 'package:gestao_de_treinos_flutter_front/enums/perfil.dart';
...
Future<Usuario> loginRequest(String email, String senha,
  ...
  // print('Treinos recebidos: ${processResponse(responseBody)['treinos']}');
